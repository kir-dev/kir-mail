...
export const AuthApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async authControllerMe(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['AuthApi.authControllerMe']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
     ...
     * @throws {RequiredError}
     */
    async authControllerOauthRedirect(
      code: any,
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['AuthApi.authControllerOauthRedirect']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
...
export class AuthApi extends BaseAPI {
  ...
  public authControllerOauthRedirect(code: any, options?: RawAxiosRequestConfig) {
    return AuthApiFp(this.configuration)
      .authControllerOauthRedirect(code, options)
      .then((request) => request(this.axios, this.basePath));
  }
}
...
export const GatewayApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
     ...
     * @throws {RequiredError}
     */
    gatewayControllerSendBulkMessages: async (
      batchSendRequestDto: BatchSendRequestDto,
      options: RawAxiosRequestConfig = {}
    ): Promise<RequestArgs> => {
     ...
     * @throws {RequiredError}
     */
    gatewayControllerSendMessage: async (
      singleSendRequestDto: SingleSendRequestDto,
      options: RawAxiosRequestConfig = {}
    ): Promise<RequestArgs> => {
     ...
     * @throws {RequiredError}
     */
    gatewayControllerSendMultiRecipientMessage: async (
      multipleSendRequestDto: MultipleSendRequestDto,
      options: RawAxiosRequestConfig = {}
    ): Promise<RequestArgs> => {
...
export const GatewayApiFp = function (configuration?: Configuration) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    async gatewayControllerGetData(
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AnalyticsDto>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.gatewayControllerGetData(options);
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['GatewayApi.gatewayControllerGetData']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
     ...
     * @throws {RequiredError}
     */
    async gatewayControllerGetHealth(
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.gatewayControllerGetHealth(options);
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['GatewayApi.gatewayControllerGetHealth']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
     ...
     * @throws {RequiredError}
     */
    async gatewayControllerSendBulkMessages(
      batchSendRequestDto: BatchSendRequestDto,
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ResponseDto>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.gatewayControllerSendBulkMessages(
        batchSendRequestDto,
        options
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['GatewayApi.gatewayControllerSendBulkMessages']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
     ...
     * @throws {RequiredError}
     */
    async gatewayControllerSendMessage(
      singleSendRequestDto: SingleSendRequestDto,
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ResponseDto>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.gatewayControllerSendMessage(
        singleSendRequestDto,
        options
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['GatewayApi.gatewayControllerSendMessage']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
     ...
     * @throws {RequiredError}
     */
    async gatewayControllerSendMultiRecipientMessage(
      multipleSendRequestDto: MultipleSendRequestDto,
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ResponseDto>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.gatewayControllerSendMultiRecipientMessage(
        multipleSendRequestDto,
        options
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['GatewayApi.gatewayControllerSendMultiRecipientMessage']?.[localVarOperationServerIndex]
          ?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
...
export const GatewayApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    gatewayControllerSendBulkMessages(
      batchSendRequestDto: BatchSendRequestDto,
      options?: any
    ): AxiosPromise<ResponseDto> {
      return localVarFp
        .gatewayControllerSendBulkMessages(batchSendRequestDto, options)
    ...
    gatewayControllerSendMessage(singleSendRequestDto: SingleSendRequestDto, options?: any): AxiosPromise<ResponseDto> {
      return localVarFp
        .gatewayControllerSendMessage(singleSendRequestDto, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
     ...
     * @throws {RequiredError}
     */
    gatewayControllerSendMultiRecipientMessage(
      multipleSendRequestDto: MultipleSendRequestDto,
      options?: any
    ): AxiosPromise<ResponseDto> {
      return localVarFp
        .gatewayControllerSendMultiRecipientMessage(multipleSendRequestDto, options)
        .then((request) => request(axios, basePath));
    },
  };
};
...
export class GatewayApi extends BaseAPI {
  ...
  public gatewayControllerGetData(options?: RawAxiosRequestConfig) {
    return GatewayApiFp(this.configuration)
      .gatewayControllerGetData(options)
      .then((request) => request(this.axios, this.basePath));
  }
  ...
  public gatewayControllerGetHealth(options?: RawAxiosRequestConfig) {
    return GatewayApiFp(this.configuration)
      .gatewayControllerGetHealth(options)
      .then((request) => request(this.axios, this.basePath));
  }
   ...
   * @memberof GatewayApi
   */
  public gatewayControllerSendMultiRecipientMessage(
    multipleSendRequestDto: MultipleSendRequestDto,
    options?: RawAxiosRequestConfig
  ) {
    return GatewayApiFp(this.configuration)
...
export const TokenApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
     ...
     * @throws {RequiredError}
     */
    tokenControllerCreateToken: async (
    ...
    tokenControllerDeleteToken: async (id: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
      ...
      const localVarPath = `/api/token/{id}`.replace(`{${'id'}}`, encodeURIComponent(String(id)));
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
      let baseOptions;
      if (configuration) {
     ...
     * @throws {RequiredError}
     */
    tokenControllerUpdateTokenQuota: async (
      id: string,
      updateTokenQuotaDto: UpdateTokenQuotaDto,
      options: RawAxiosRequestConfig = {}
    ): Promise<RequestArgs> => {
      // verify required parameter 'id' is not null or undefined
      ...
      const localVarPath = `/api/token/{id}/quota`.replace(`{${'id'}}`, encodeURIComponent(String(id)));
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
      let baseOptions;
      if (configuration) {
...
export const TokenApiFp = function (configuration?: Configuration) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    async tokenControllerCreateToken(
      createTokenDto: CreateTokenDto,
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<TokenDto>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.tokenControllerCreateToken(createTokenDto, options);
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['TokenApi.tokenControllerCreateToken']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
     ...
     * @throws {RequiredError}
     */
    async tokenControllerDeleteToken(
      id: string,
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['TokenApi.tokenControllerDeleteToken']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
     ...
     * @throws {RequiredError}
     */
    async tokenControllerGetTokens(
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<TokenDto>>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.tokenControllerGetTokens(options);
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['TokenApi.tokenControllerGetTokens']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
     ...
     * @throws {RequiredError}
     */
    async tokenControllerUpdateTokenQuota(
      id: string,
      updateTokenQuotaDto: UpdateTokenQuotaDto,
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<TokenDto>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.tokenControllerUpdateTokenQuota(
        id,
        updateTokenQuotaDto,
        options
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['TokenApi.tokenControllerUpdateTokenQuota']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
...
export const TokenApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    tokenControllerUpdateTokenQuota(
      id: string,
      updateTokenQuotaDto: UpdateTokenQuotaDto,
      options?: any
    ): AxiosPromise<TokenDto> {
      return localVarFp
        .tokenControllerUpdateTokenQuota(id, updateTokenQuotaDto, options)
        .then((request) => request(axios, basePath));
    },
  };
};
...
export class TokenApi extends BaseAPI {
  ...
  public tokenControllerCreateToken(createTokenDto: CreateTokenDto, options?: RawAxiosRequestConfig) {
    return TokenApiFp(this.configuration)
      .tokenControllerCreateToken(createTokenDto, options)
      .then((request) => request(this.axios, this.basePath));
  }
  ...
  public tokenControllerDeleteToken(id: string, options?: RawAxiosRequestConfig) {
    return TokenApiFp(this.configuration)
      .tokenControllerDeleteToken(id, options)
      .then((request) => request(this.axios, this.basePath));
  }
   ...
   * @memberof TokenApi
   */
  public tokenControllerUpdateTokenQuota(
    id: string,
    updateTokenQuotaDto: UpdateTokenQuotaDto,
    options?: RawAxiosRequestConfig
  ) {
